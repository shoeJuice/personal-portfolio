...
import {Box, Flex, Heading, Text, useColorModeValue, HStack, Link, theme} from '@chakra-ui/react';
...
const Footer = () => {
    return (<Flex
      ...
      >
        ...
        <Text>
          Splash Image by Pablo Stanley, courtesy of{" "}
          {
            <NextLink href="https://blush.design/" passHref>
              <Link
                _hover={{
                  color: useColorModeValue(theme.colors.blackAlpha[900], theme.colors.whiteAlpha[900]),
        ...
        <HStack fontSize="xs">
          ...
          <NextLink href="https://icons8.com/icon/108784/javascript" passHref>
            ...
            >JavaScript Icon</Link>
          </NextLink>
          <NextLink href="https://icons8.com/icon/uJM6fQYqDaZK/typescript" passHref>
            <Link 
              _hover={{
                color: useColorModeValue(theme.colors.blackAlpha[900], theme.colors.whiteAlpha[900]),
                textDecoration: "underline",
              }}
            >TypeScript Icon</Link>
          </NextLink>
        </HStack>
      </Flex>);
};
